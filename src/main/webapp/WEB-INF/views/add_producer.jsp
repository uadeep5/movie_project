...
<form action="/producer/add" enctype="multipart/form-data" method="post">
    ...
    <input style="margin-left: 15px;width: 96%;border-radius: 4px;" class="form-group" name="birthdayDate" type="date" placeholder="Enter birthDate">
